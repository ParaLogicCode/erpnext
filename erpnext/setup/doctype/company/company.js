...
erpnext.company.setup_queries = function(frm) {
	$.each([
		...
		["exchange_gain_loss_account", {"report_type": "Profit and Loss"}],
		["unrealized_exchange_gain_loss_account", {"report_type": "Profit and Loss"}],
		["default_deferred_expense_account", {"report_type": "Profit and Loss"}],
		["default_deferred_revenue_account", {"report_type": "Profit and Loss"}],
		["discount_allowed_account", {"report_type": "Profit and Loss"}],
		["discount_received_account", {"report_type": "Profit and Loss"}],
		...
		["default_employee_advance_account", {"account_type": ["in", ["Payable", "Receivable"]]}],
		["default_employee_loan_account", {"account_type": ["in", ["Payable", "Receivable"]]}],
		["default_expense_claim_payable_account", {"account_type": ["in", ["Payable", "Receivable"]]}],
		["default_letter_of_credit_account", {"account_type": ["in", ["Payable", "Receivable"]]}],
		["expenses_included_in_asset_valuation", {"account_type": "Expenses Included In Asset Valuation"}],
		["capital_work_in_progress_account", {"account_type": "Capital Work in Progress"}],
		["asset_received_but_not_billed", {"account_type": "Asset Received But Not Billed"}],
		["service_warranty_provision_account", {"report_type": "Balance Sheet"}],
		["service_warranty_expense_account", {"report_type": "Profit and Loss"}],
	], function(i, v) {
